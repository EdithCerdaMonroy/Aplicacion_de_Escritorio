 ...
 * @author edith
 */
public class BuscarPredio extends javax.swing.JFrame {

    /**
     * Creates new form BuscarPredio
     */
    public BuscarPredio() {
        initComponents();
    }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(BuscarPredio.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new BuscarPredio().setVisible(true);
            }
        });
    }
